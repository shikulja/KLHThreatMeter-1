...
klhtm.string.data["ruRU"] = 
{
	...
	["boss"] = 
	{
		["speech"] = 
		{
			...
			["nefphase1"] = "Браво, слуги мои! Смертные утрачивают мужество!", --vmangos+old надо проверить м.б. добавить (.*) если не парсится
		...
		["spell"] = 
		{
			...
			fireball = "(.*)\"Огненный шар\" Ониксия(.*)", --надо проверить
			--"Ониксия начинает использовать \"Огненный шар\".",
			--"Огненный шар" Ониксия наносит Mortalstrike 927 ед. урона (Огонь).
			--Baylouch поглощает заклинание "Огненный шар" Ониксия.
		}
	},
	["misc"] = 
	{
