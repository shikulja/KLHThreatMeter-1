...
klhtm.string.data["ruRU"] = 
{
	...
	["boss"] = 
	{
		["speech"] = 
		{
			...
			["nefphase1"] = "Браво, слуги мои! Смертные утрачивают мужество! Поглядим же, как они справятся с истинным Повелителем Черной горы!!!", --vmangos
			--["nefphase1"] = "Браво, слуги мои! Смертные утрачивают мужество! Поглядим же, как они справятся с истинным владыкой Черной горы!!!", --old
		...
		["spell"] = 
		{
			...
			fireball = "Огненный шар", --"Ониксия начинает использовать \"Огненный шар\".", --"Огненный шар" Ониксия наносит Mortalstrike 927 ед. урона (Огонь). --Baylouch поглощает заклинание "Огненный шар" Ониксия.
		}
	},
	["misc"] = 
	{
